...
INSERT INTO transaction_subcategories (name, detailed_name, description, category_id) VALUES
	...
	('Transfer In to Investments','Transfer In Investment and Retirement Funds','Inbound transfers to an investment or retirement account', 2),
	('Transfer In to Savings','Transfer In Savings','Inbound transfers to a savings account', 2),
	('Transfer In','Transfer In Other Transfer In','Other miscellaneous inbound transactions', 2),
	('Transfer Out to Investments','Transfer Out Investment and Retirement Funds','Transfers to an investment or retirement account, including investment apps such as Acorns, Betterment', 2),
	('Transfer Out to Savings','Transfer Out Savings','Outbound transfers to savings accounts', 2),
	('Withdraw','Transfer Out Withdrawal','Withdrawals from a bank account', 3),
	('Transfer Out','Transfer Out Other Transfer Out','Other miscellaneous outbound transactions', 3),
	('Car Payment','Loan Payments Car Payment','Car loans and leases', 4),
	('Credit Card Interest','Loan Payments Credit Card Interest','Payments to a credit card to cover and accrued interest. These are positive amounts for credit card subtypes and negative for depository subtypes', 3),
	('Personal Loan','Loan Payments Personal Loan Payment','Personal loans, including cash advances and buy now pay later repayments', 4),
	('Mortgage','Loan Payments Mortgage Payment','Payments on mortgages', 4),
	('Student Loans','Loan Payments Student Loan Payment','Payments on student loans. For college tuition, refer to "General Services - Education"', 4),
	('Loan Payments','Loan Payments Other Payment','Other miscellaneous debt payments', 4),
	('ATM Fees','Bank Fees ATM Fees','Fees incurred for out-of-network ATMs', 3),
	('Foreign Transaction Fee','Bank Fees Foreign Transaction Fees','Fees incurred on non-domestic transactions', 3),
	('Insufficient Funds Fee','Bank Fees Insufficient Funds','Fees relating to insufficient funds', 3),
	('Interest Fees','Bank Fees Interest Charge','Fees incurred for interest on purchases, including not-paid-in-full or interest on cash advances', 3),
	('Overdraft Fees Fees','Bank Fees Overdraft Fees','Fees incurred when an account is in overdraft', 3),
	('Bank Fees','Bank Fees Other Bank Fees','Other miscellaneous bank fees', 3),
	('Casinos and Gambling','Entertainment Casinos and Gambling','Gambling, casinos, and sports betting', 3),
	('Music and Audio','Entertainment Music and Audio','Digital and in-person music purchases, including music streaming services', 3),
	...
	('Entertainment','Entertainment Other Entertainment','Other miscellaneous entertainment purchases, including night life and adult entertainment', 3),
	('Beer and Liquor','Food and Drink Beer Wine and Liquor','Beer, Wine & Liquor Stores', 3),
	('Coffee Shops','Food and Drink Coffee','Purchases at coffee shops or cafes', 3),
	('Fast Food','Food and Drink Fast Food','Dining expenses for fast food chains', 3),
	('Groceries','Food and Drink Groceries','Purchases for fresh produce and groceries, including farmers markets', 3),
	('Restaurants','Food and Drink Restaurant','Dining expenses for restaurants, bars, gastropubs, and diners', 3),
	('Vending Machines','Food and Drink Vending Machines','Purchases made at vending machine operators', 3),
	('Food and Drink','Food and Drink Other Food and Drink','Other miscellaneous food and drink, including desserts, juice bars, and delis', 3),
	('Bookstores','General Merchandise Bookstores and Newsstands','Books, magazines, and news', 3),
	('Clothes and Accessories','General Merchandise Clothing and Accessories','Apparel, shoes, and jewelry', 3),
	('Convenience Stores','General Merchandise Convenience Stores','Purchases at convenience stores', 3),
	('Department Stores','General Merchandise Department Stores','Retail stores with wide ranges of consumer goods, typically specializing in clothing and home goods', 3),
	('Thrift and Discount Stores','General Merchandise Discount Stores','Stores selling goods at a discounted price', 3),
	('Electronics','General Merchandise Electronics','Electronics stores and websites', 3),
	('Gifts and Novelties','General Merchandise Gifts and Novelties','Photo, gifts, cards, and floral stores', 3),
	('Office Supplies','General Merchandise Office Supplies','Stores that specialize in office goods', 3),
	('Online Shopping','General Merchandise Online Marketplaces','Multi-purpose e-commerce platforms such as Etsy, Ebay and Amazon', 3),
	('Pet Supplies','General Merchandise Pet Supplies','Pet supplies and pet food', 3),
	('Sporting Goods','General Merchandise Sporting Goods','Sporting goods, camping gear, and outdoor equipment', 3),
	('Superstores','General Merchandise Superstores','Superstores such as Target and Walmart, selling both groceries and general merchandise', 3),
	('Tobacco and Vape','General Merchandise Tobacco and Vape','Purchases for tobacco and vaping products', 3),
	('General Merchandise Other','General Merchandise Other General Merchandise','Other miscellaneous merchandise, including toys, hobbies, and arts and crafts', 3),
	('Furniture','Home Improvement Furniture','Furniture, bedding, and home accessories', 3),
	('Home Improvement Hardware','Home Improvement Hardware','Building materials, hardware stores, paint, and wallpaper', 3),
	('Home Maintenance and Repair','Home Improvement Repair and Maintenance','Plumbing, lighting, gardening, and roofing', 3),
	('Home Security','Home Improvement Security','Home security system purchases', 3),
	('Home Improvement','Home Improvement Other Home Improvement','Other miscellaneous home purchases, including pool installation and pest control', 3),
	('Dental Care','Medical Dental Care','Dentists and general dental care', 3),
	('Eye Care','Medical Eye Care','Optometrists, contacts, and glasses stores', 3),
	...
	('Education','General Services Education','Elementary, high school, professional schools, and college tuition', 4),
	('Insurance','General Services Insurance','Insurance for auto, home, and healthcare', 4),
	...
	('Donations','Government and Non-Profit Donations','Charitable, political, and religious donations', 3),
	('Tax Payments','Government and Non-Profit Tax Payment','Tax payments, including income and property taxes', 3),
	('Government and Non-Profit','Government and Non-Profit Other Government and Non-Profit','Other miscellaneous government and non-profit agencies', 3),
	...
	('Tolls','Transportation Tolls','Toll expenses', 3),
	...
	('Lodging','Travel Lodging','Hotels, motels, and hosted accommodation such as Airbnb', 3),
	...
	('Gas and Electric Bill','Rent and Utilities Gas and Electricity','Gas and electricity bills', 4),
	('Cable and Internet','Rent and Utilities Internet and Cable','Internet and cable bills', 4),
	('Rent','Rent and Utilities Rent','Rent payment', 4),
